...
\def\readblanks\then#1\done{%
  \begingroup
  \def\ignoreblanks@E{%
    %[ignoreblanks@E]\par\medbreak\hrule\medbreak
    \endgroup#1%
  }%
  \ignoreblanks@M
}
...
\long\def\ignoreblanks@B#1{%
  %[ignoreblanks@B]\par
  %* \string#1 -> \meaning#1\par
  %* comparison = \meaning\rmA\par
  %* ignoreblanks@T = \meaning\ignoreblanks@T\par
  \ifx #1\ignoreblanks@T
    %* it matches!\par
    \flagfalse
  \fi
}
...
%% \def\ignoreblanks@D{%
%%   %[ignoreblanks@D]\par
%%   \afterassignment\ignoreblanks@M
%%   \let\ignoreblanks@T
%% }
